...
<!--/*
 *Mit diesem Formluar können neue Kosten erfasst werden.
 */-->
                ...
                <div class="input-group">
                    <div class="input-group-btn">
                        ...
                        <ul class="dropdown-menu">
                            <li><a onClick="window.location.href = '<?php echo base_url(); ?>index.php/kosten/umrechnen';
                                    return false;"><?php echo $this->lang->line('euro'); ?></a></li>
                        </ul>
                    </div>
<?php echo form_input($kosten); ?>
                </div>
...
<?php endfor; ?>
        ...
        <div class="form-group">
            <br/>
            <button type="submit" class="btn btn-primary"><?php echo $this->lang->line('common_form_elements_go'); ?></button>   <button class="btn btn-primary" onClick="window.location.href = '<?php echo base_url(); ?>index.php/kosten';
