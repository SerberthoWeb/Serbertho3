...
<?php echo form_open('kosten/new_kostenstelle','role="form" class="form"') ; ?> 
  ...
  <div class="form-group">
      ...
      <?php echo form_input($kostenstelle_name); ?>
          ...
          <div class="form-group">
      <button type="submit" class="btn btn-success"><?php echo $this->lang->line('common_form_elements_go');?></button>   <button class="btn btn-success" onClick="window.location.href = '<?php echo base_url();?>index.php/kosten/kostenstelle';return false;"><?php echo $this->lang->line('common_form_elements_cancel');?></button> 
    </div> 
<?php echo form_close() ; ?>
  </div>
</div>
